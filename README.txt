...
M + S is really 25 + 11.  
This exceeds the table size so we wrap around and continue counting from the beginning to reach 10, which = A


And so on.  
Notice that spaces and any other characters not contained in the lookup table are ignored.
